...
export default class CategoryPage extends React.Component<CategoryPageProperties>{
    ...
    private setMessage(poruka: string){
        const newState = Object.assign(this.state,{
          message: poruka,
        });
        this.setState(newState);
    ...
    private printFeatureFilterCheckBox(feature: any, value: string){
        return (
            <Form.Check type="checkbox" label={value} value={value} data-feature-id = {feature.featureId}
          ...
          <Col lg="4" md="6" sm ="6" xs ="12" >
            <Card className="mb-3">
                ...
                <Card.Body>
                    ...
                    <Link to={`/article/${article.articleId}`} className="btn btn-primary d-block btn-sm">
                    Open article page
                    </Link>
                </Card.Body>
            </Card>
